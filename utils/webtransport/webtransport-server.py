...
#      to use the self-signed certificate.  Include both localhost and 127.0.0.1:
...
if __name__ == '__main__':
    ...
    async def run_server():
        ...
        logger.info("WebTransport endpoint available at: https://localhost:{}/counter".format(BIND_PORT))
