...
const xt = "@ecmaos/swapi", It = "0.2.0", ee = {
  name: xt,
  version: It
...
self.addEventListener("fetch", (e) => {
  ...
  a.method === "GET" && (r.pathname.includes("/swapi.js") || r.pathname.includes("/manifest.json") || e.respondWith(
    (async () => {
      const n = await caches.open(re);
      if (/\.(js|css|png|jpg|jpeg|gif|svg|ico|woff|woff2|ttf|eot|wasm)$/i.test(r.pathname)) {
        const u = await n.match(a);
        if (u)
          return u;
        try {
          const t = await fetch(a);
          return t.ok && n.put(a, t.clone()), t;
        } catch (t) {
          throw t;
        }
      } else
        try {
          ...
          return u.ok && n.put(a, u.clone()), u;
        } catch (u) {
          const t = await n.match(a);
          if (t)
            return t;
          throw u;
        }
